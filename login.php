    ...
    <div class="row middle-form">
      ...
      <div class="col-md-6">
        <div class="panel panel-default">
          <div class="panel-heading">EverGalax - Login</div><br>
          <div class="panel-body">
            <form class="form-horizontal" role="form" method="post">
              <div class="form-group">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                  <input class="form-control" type="text" id="email" placeholder="Email Id or Username" required autofocus>
                </div>
                <div class="col-sm-3"></div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-6 fgt-pass pull-right">
              ...
              <div class="form-group">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                  <a href="./register.php" class="pull-left"><u>New Here? Create an account.<u></a>
                  <br>
                </div>
                <div class="col-sm-3"></div>
              </div>
